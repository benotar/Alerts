...
public static class AlertsHelper
{
    ...
    public static bool IsActiveAlert(AlertsModels.Alerts alerts ,string region)
    {
        if (!_allLocationsString.ContainsValue(region))
        {
            return false;
        }

        var result = alerts.LocationTitle == region;
